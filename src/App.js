import './App.css';
import routineHomepage from './img/routineapp.PNG';
import routineHomepage2 from './img/RoutineHomepage.PNG';
    ...
    <div className="App">
      <header className="App-header">
          <div className="nameEntry">
            <div>hello</div>
            <div>My name is Benson Chen</div>
          </div>
          <div className="bot">Welcome to my portfolio</div>
      </header>
